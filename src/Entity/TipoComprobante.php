...
class TipoComprobante
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Comprobante::class, mappedBy="tipo_comprobante_id")
     */
    ...
    public function addComprobante(Comprobante $comprobante): self
    {
        if (!$this->comprobantes->contains($comprobante)) {
            ...
            $comprobante->setTipoComprobanteId($this);
        }
    ...
    public function removeComprobante(Comprobante $comprobante): self
    {
        if ($this->comprobantes->contains($comprobante)) {
            ...
            if ($comprobante->getTipoComprobanteId() === $this) {
                $comprobante->setTipoComprobanteId(null);
            }
        }
