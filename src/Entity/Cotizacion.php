...
class Cotizacion
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=PuntoVenta::class, inversedBy="cotizacions")
     */
    private $punto_venta_id;

    /**
     * @ORM\ManyToOne(targetEntity=Cliente::class, inversedBy="cotizacions")
     */
    private $cliente_id;

    /**
     * @ORM\ManyToOne(targetEntity=Empresa::class, inversedBy="cotizacions")
     */
    private $empresa_id;
    ...
    /**
     * @ORM\OneToMany(targetEntity=CotizacionProducto::class, mappedBy="cotizacion_id")
     */
    ...
    public function addCotizacionProducto(CotizacionProducto $cotizacionProducto): self
    {
        if (!$this->cotizacionProductos->contains($cotizacionProducto)) {
            ...
            $cotizacionProducto->setCotizacionId($this);
        }
    ...
    public function removeCotizacionProducto(CotizacionProducto $cotizacionProducto): self
    {
        if ($this->cotizacionProductos->contains($cotizacionProducto)) {
            ...
            if ($cotizacionProducto->getCotizacionId() === $this) {
                $cotizacionProducto->setCotizacionId(null);
            }
        }
